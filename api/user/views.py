...
def signin(request):
    ...
    try:
        ...
        if user.check_password(password):
            ...
            usr_dict.pop('password') #We dont want to get password into frontend

            if user.session_token != '0': #When the next time user login, it is 0
...
def signout(request, id):
    ...
    return JsonResponse({'succcess': 'Logout success'})
